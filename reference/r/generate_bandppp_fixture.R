...
write.table(
  X,
  file = file.path(fixture_dir, "bandppp_x.csv"),
  sep = ",",
  row.names = FALSE,
  col.names = FALSE,
  quote = FALSE
...
write.table(
  summary,
  file = file.path(fixture_dir, "bandppp_summary.csv"),
  sep = ",",
  row.names = FALSE,
  col.names = TRUE,
  quote = FALSE
...
writeLines(session_info, file.path(fixture_dir, "bandppp_session_info.txt"))
